...
y = drawResearchBullets(pdf, conclusionLines, 50, y);
...
y = drawResearchBullets(pdf, methodologyLines, 50, y);
...
y = drawResearchBullets(pdf, limitationLines, 50, y);
...
y = drawResearchBullets(pdf, recommendationLines, 50, y);
...
y = drawSectionCallout(
  pdf,
  `2.${summarySectionNumber} Appendix / Source Reference`,
  y,
);
...
y = drawResearchBullets(pdf, appendixLines, 50, y);
