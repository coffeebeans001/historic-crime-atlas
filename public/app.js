...
const appendixLines = [
  `Source filters: ${sourceReference}`,
  ...(includeMapInPdf
    ? [
        "Appendix A: Research Map included with this report.",
      ]
    : []),

  `Research ID: ${researchId}`,
  `Report version: ${reportVersion}`,
  "Generated by Old Bailey Analytics research workspace.",
];
y = drawResearchSection(
  pdf,
  "Appendix / Source Reference",
...
const mapAppendixLines = pdf.splitTextToSize(
  "This appendix presents the geographic distribution of cases matching the selected research filters. Where multiple cases occur within the same visible area, they are grouped into marker clusters to improve map readability while preserving the overall spatial distribution.",
  510,
);
